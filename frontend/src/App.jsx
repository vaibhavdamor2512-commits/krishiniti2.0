...
import { Advisories, DiseaseAdvisor, Notifications, SettingsPage } from './pages/Guidance'
import { NDVI, Weather } from './pages/Monitoring'
import Recommendations, { Profit } from './pages/Recommendations'
import Welcome from './pages/Welcome'

function Protected(){const {user}=useApp();return user?<AppShell/>:<Navigate to="/login" replace/>}

function AppRoutes(){return <Routes>
  <Route path="/" element={<Welcome/>}/><Route path="/login" element={<Login/>}/><Route path="/register" element={<Register/>}/><Route path="/language" element={<Language/>}/>
